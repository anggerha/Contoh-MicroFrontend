                                        ...
                                        <article class="card p-4 shadow p-2 mb-3 bg-white rounded" v-for="item in daftarBerita[statusBerita].slice(page*10-10,page*10 )" :key="item.id">
                                            ...
                                            <div class="footer">
                                                ...
                                                <b-row >
                                                    <b-col>
                                                        <div class="button">
                                                            <b-button block @click="sendDataBerita(item)" style="margin: .2rem; justify-content: center;" type="button" class="shadow-sm btn-general">
                                                    ...
                                                    <b-col>
                                                        <div class="button">
                                                            <b-button block @click="hapusBerita(item)" style="margin: .2rem; justify-content: center;" class="hapusPengumuman shadow-sm btn-general">
